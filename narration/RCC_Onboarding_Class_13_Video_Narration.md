# Class 13: RCC storage architecture — video narration

## Slide 1: Class 13: RCC storage architecture

Welcome to Class 13: RCC storage architecture. This video introduces the core decisions and working patterns. Watch the complete lesson first, then use the written class page for copyable commands, exercises, and detailed reference material.
