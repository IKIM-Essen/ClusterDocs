# Class 10: R notebooks and large-data analysis — video narration

## Slide 1: Class 10: R notebooks and large-data analysis

Welcome to Class 10: R notebooks and large-data analysis. This video introduces the core decisions and working patterns. Watch the complete lesson first, then use the written class page for copyable commands, exercises, and detailed reference material.
...
Start from the provided example: For an interactive R notebook, use the Jupyter example from Class 9. The environment already includes an R kernel.
