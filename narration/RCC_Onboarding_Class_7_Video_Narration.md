# Class 7: Python notebooks for large datasets — video narration

## Slide 1: Class 7: Python notebooks for large datasets

Welcome to Class 7: Python notebooks for large datasets. This video introduces the core decisions and working patterns. Watch the complete lesson first, then use the written class page for copyable commands, exercises, and detailed reference material.
