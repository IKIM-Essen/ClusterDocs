# Class 17: manage the research data lifecycle — video narration

## Slide 1: Class 17: manage the research data lifecycle

Welcome to Class 17: manage the research data lifecycle. This video introduces the core decisions and working patterns. Watch the complete lesson first, then use the written class page for copyable commands, exercises, and detailed reference material.
