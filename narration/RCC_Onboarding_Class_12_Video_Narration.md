# Class 12: efficient I/O—copy locally, compute locally, return results — video narration

## Slide 1: Class 12: efficient I/O—copy locally, compute locally, return results

Welcome to Class 12: efficient I/O—copy locally, compute locally, return results. This video introduces the core decisions and working patterns. Watch the complete lesson first, then use the written class page for copyable commands, exercises, and detailed reference material.
