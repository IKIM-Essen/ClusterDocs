...
NAV=[
 ...
 ('Data lifecycle','Legacy Windows storage access','data/legacy-storage-windows.md'),
 ('Data lifecycle','Legacy macOS storage access','data/legacy-storage-macos.md'),
 ...
 ('Reference','Endpoint compatibility','connecting/stable-endpoints.md'),
