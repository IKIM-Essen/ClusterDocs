...
class DataLifecycleCourseTests(unittest.TestCase):
    def test_course_and_planned_flow_exist(self):
        required = [
            ROOT / "docs/course/class-17-data-lifecycle.md",
    ...
    def test_course_covers_coscine_and_safe_archive_acceptance(self):
        page = (ROOT / "docs/course/class-17-data-lifecycle.md").read_text().lower()
        for phrase in [
    ...
    def test_navigation_keeps_class_numbering_and_flow_link(self):
        ...
        self.assertIn("Class 17 - Research data lifecycle", mkdocs)
        self.assertIn("Class 17 · Research data lifecycle", builder)
