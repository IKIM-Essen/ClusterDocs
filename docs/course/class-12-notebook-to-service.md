...
<section class="course-video-hero" id="watch-first">
  ...
  <video controls preload="metadata" playsinline poster="../../assets/video-posters/class12.png" src="{{ media_base_url }}/RCC_Onboarding_Class_12_Video_Enhanced.mp4?v=157f9f39">
