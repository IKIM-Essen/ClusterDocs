...
<section class="course-video-hero" id="watch-first">
  ...
  <video controls preload="metadata" playsinline poster="../../assets/video-posters/class8.png" src="{{ media_base_url }}/RCC_Onboarding_Class_8_Video_Enhanced.mp4?v=d07cccc5">
