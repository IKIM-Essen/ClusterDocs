# Class 11: Shiny applications on RCC
...
<section class="course-video-hero" id="watch-first">
  ...
  <video controls preload="metadata" playsinline poster="../../assets/video-posters/class11.png" src="{{ media_base_url }}/RCC_Onboarding_Class_11_Video_Enhanced.mp4?v=43775d95">
...
2. **Future service for other users:** after project vhosts are released, the
   application must go through the governed process described in Class 8.
