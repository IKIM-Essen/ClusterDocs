...
<section class="course-video-hero" id="watch-first">
  ...
  <video controls preload="metadata" playsinline poster="../../assets/video-posters/class8.png" src="{{ media_base_url }}/RCC_Onboarding_Class_8_Video_Enhanced.mp4?v=2319f71d">
    <track kind="captions" srclang="en" label="English captions" src="../../assets/captions/RCC_Onboarding_Class_8_Captions.vtt" default>
