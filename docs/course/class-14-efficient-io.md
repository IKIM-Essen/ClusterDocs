# Class 14: efficient I/O—copy locally, compute locally, return results
...
<section class="course-video-hero" id="watch-first">
  ...
  <video controls preload="metadata" playsinline poster="../../assets/video-posters/class14.png" src="{{ media_base_url }}/RCC_Onboarding_Class_14_Video_Enhanced.mp4?v=e85798d9">
...
- continue with [Class 15: RCC storage architecture](class-15-storage-architecture.md).
